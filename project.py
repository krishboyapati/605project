...
# -*- coding: utf-8 -*-
"""unsupervised-topic-extraction-of-user-review.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/118IiKz4-RMnntNEYcKA7qOB9Y6uwSvoT

<a href="https://colab.research.google.com/github/yuriao/DataScienceProjects/blob/main/Unsupervised_Learning_Project.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
print (" ######################################################################################")
# clister_reviews.to_csv("out.csv")
...
print(df_topic_words.iloc[:,0:7])

print("###################################################################################")


print(df_topic_words.iloc[:,8:15])
